...
try
{
	...
	String piid=request.getParameter("fid");
    
    Statement stmt = con.createStatement();
    ResultSet flag=stmt.executeQuery(" select * from facul where fid='"+piid+"'    ");

    if(flag.next())
    {
        ResultSet rs=stmt.executeQuery(" select * from facul where fid='"+piid+"'  ");
