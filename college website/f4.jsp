...
try
{
	...
	String piid=request.getParameter("fs");
    
    Statement stmt = con.createStatement();
    ResultSet flag=stmt.executeQuery(" select * from facul where subject='"+piid+"'    ");

    if(flag.next())
    {
        ResultSet rs=stmt.executeQuery(" select * from facul where subject='"+piid+"'  ");
