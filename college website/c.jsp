...
try
{
	...
	String piid=request.getParameter("de");
    
    Statement stmt = con.createStatement();
    ResultSet flag=stmt.executeQuery(" select subject from facul where department='"+piid+"'    ");

    if(flag.next())
    {
        ResultSet rs=stmt.executeQuery(" select subject from facul where department='"+piid+"'  ");
