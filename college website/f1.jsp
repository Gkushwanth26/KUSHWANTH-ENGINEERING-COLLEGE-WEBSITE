...
try
{
	...
	String piid=request.getParameter("fname");
    
    Statement stmt = con.createStatement();
    ResultSet flag=stmt.executeQuery(" select * from facul where fname='"+piid+"'    ");

    if(flag.next())
    {
        ResultSet rs=stmt.executeQuery(" select * from facul where fname='"+piid+"'  ");
